...
public class GetSessionExResponse  implements java.io.Serializable {
    private com.dummy.controller.session.ResponseSession responseSession;

    public GetSessionExResponse() {
    }
    ...
    /**
     * Gets the responseSession value for this GetSessionExResponse.
     * 
    ...
    /**
     * Sets the responseSession value for this GetSessionExResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof GetSessionExResponse)){
        	return false;
        }
        GetSessionExResponse other = (GetSessionExResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSessionExResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:dummy:WebSecurity:WebServices", ">GetSessionExResponse"));
