/**
 * GetAndExtendSessionExResponse.java
 *
...
public class GetAndExtendSessionExResponse  implements java.io.Serializable {
    private com.dummy.controller.session.ResponseSession responseSession;

    public GetAndExtendSessionExResponse() {
    }
    ...
    /**
     * Gets the responseSession value for this GetAndExtendSessionExResponse.
     * 
    ...
    /**
     * Sets the responseSession value for this GetAndExtendSessionExResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof GetAndExtendSessionExResponse)){
        	return false;
        }
        GetAndExtendSessionExResponse other = (GetAndExtendSessionExResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAndExtendSessionExResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:dummy:WebSecurity:WebServices", ">GetAndExtendSessionExResponse"));
