/**
 * GetAndExtendSessionResponse.java
 *
...
public class GetAndExtendSessionResponse  implements java.io.Serializable {
    private com.dummy.controller.session.ResponseSession responseSession;

    public GetAndExtendSessionResponse() {
    }
    ...
    /**
     * Gets the responseSession value for this GetAndExtendSessionResponse.
     * 
    ...
    /**
     * Sets the responseSession value for this GetAndExtendSessionResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof GetAndExtendSessionResponse)){
        	return false;
        }
        GetAndExtendSessionResponse other = (GetAndExtendSessionResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAndExtendSessionResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:dummy:WebSecurity:WebServices", ">GetAndExtendSessionResponse"));
